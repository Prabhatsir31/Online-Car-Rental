    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          ...
          <div class="logo"><a href="index.php" style="font-size: 25px; color: royalblue; border: 5px solid black; padding:2px; "><sup>O</sup>CarRental</a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">helpline@gmail.com</a> </div>
            <div class="header_widgets">
